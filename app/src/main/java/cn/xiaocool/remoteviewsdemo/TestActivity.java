...
public class TestActivity extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        RemoteViews myRemoteViews = new RemoteViews(context.getPackageName(), R.layout.remoteview_layout);
        //myRemoteViews.setImageViewResource(R.id.imageView, R.drawable.png1);//设置布局控件的属性（要特别注意）
        myRemoteViews.setOnClickPendingIntent(R.id.rm_img, pendingIntent);
        ComponentName myComponentName = new ComponentName(context, TestActivity.class);//是用来打开其他应用程序中的Activity或服务的。
